...
from openpilot.selfdrive.controls.lib.longitudinal_mpc_lib.long_mpc import desired_follow_distance, get_T_FOLLOW, STOP_DISTANCE
...
class TestFollowingDistance(unittest.TestCase):
  def test_following_distance(self):
    ...
    correct_steady_state = desired_follow_distance(v_lead, v_lead, get_T_FOLLOW(self.personality), stop_distance=STOP_DISTANCE)
